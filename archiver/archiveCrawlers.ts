...
import { GoogleConfigSheets } from 'google/google';
...
export const archiveOldShowlists = async () => {
  const contentfullIds = [
    { showlistId: 'syssyradio2020', name: 'syssyradio20202' },
    // { showlistId: 'wappuradio2021', name: 'wappuradio2021' },
    // { showlistId: 'wappuradio2022', name: 'wappuradio2022' },
    // { showlistId: 'syssyradio-2022', name: 'syssyradio2022' },
  ];
  ...
  // for(const { config, name } of sheetConfigs) {
  //   await archiveGogleSheet(config, name);
  // }
};
...
// const archiveGogleSheet = async (config: GoogleConfigSheets, name: string) => {
//   const showlist = await fetchShowlistSheet();
//   await archiveJson(name, showlist);
// };
