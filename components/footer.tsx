...
const Footer = ({ navigationItems }: FooterProps) => {
  return (
    /* <footer className="pb-32 z-15 flex max-w-full flex-col flex-wrap items-center justify-center bg-blue-darkest py-14 text-white lg:flex-row"> */
    <footer className="pb-32 z-15 flex max-w-full flex-col flex-wrap items-center justify-center bg-purple-light py-14 text-white lg:flex-row">
